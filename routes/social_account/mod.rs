...
use crate::types::insight::account_insight_history::AccountInsightHistory;
use crate::types::domain::account_references::AccountReferences;
...
use crate::types::social_account::set_social_account_group_request::SetSocialAccountGroupRequest;
...
pub async fn group_references(__client: &crate::runtime::Client, social_account_uid: &str) -> crate::runtime::ApiResult<AccountReferences> {
  let mut __path = String::from("/social-account/{social_account_uid}/group/reference");
  __path = __path.replace("{social_account_uid}", &crate::runtime::encode_path(social_account_uid));
  __client.request(crate::runtime::Method::GET, &__path, None::<&()>, None::<&()>).await
}
...
pub async fn insights_history(__client: &crate::runtime::Client, social_account_uid: &str, __query: &InsightHistoryQuery) -> crate::runtime::ApiResult<AccountInsightHistory> {
...
pub async fn set_group(__client: &crate::runtime::Client, social_account_uid: &str, __body: &SetSocialAccountGroupRequest) -> crate::runtime::ApiResult<()> {
  let mut __path = String::from("/social-account/{social_account_uid}/group");
  __path = __path.replace("{social_account_uid}", &crate::runtime::encode_path(social_account_uid));
  __client.request(crate::runtime::Method::PUT, &__path, None::<&()>, Some(__body)).await
}
