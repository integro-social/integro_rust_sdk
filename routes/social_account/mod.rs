...
pub async fn callback(client: &Client, query: &ConnectCallbackQuery) -> ApiResult<()> {
...
pub async fn connect(client: &Client, body: &ConnectSocialAccountRequest) -> ApiResult<ConnectSocialAccountResponse> {
...
pub async fn connect_confirm(client: &Client, body: &ConnectConfirmRequest) -> ApiResult<ConnectSocialAccountsConnected> {
...
///
/// Requires `ConnectSocialAccounts` in the group the stashed grant targets.
pub async fn connect_review(client: &Client, query: &ConnectReviewQuery) -> ApiResult<ConnectReviewResponse> {
...
///
/// Requires `ConnectSocialAccounts` in the named group.
pub async fn connect_stevo(client: &Client, body: &ConnectStevoRequest) -> ApiResult<ConnectStevoResponse> {
...
///
/// Requires `ConnectSocialAccounts` in the named group.
pub async fn connect_whatsapp(client: &Client, body: &ConnectWhatsappRequest) -> ApiResult<ConnectWhatsappResponse> {
...
pub async fn count(client: &Client, query: &ListSocialAccountsQuery) -> ApiResult<u64> {
...
pub async fn delete(client: &Client, social_account_uid: &str) -> ApiResult<()> {
...
pub async fn get(client: &Client, social_account_uid: &str) -> ApiResult<SocialAccountResponse> {
  let mut __path = String::from("/social-account/{social_account_uid}");
  __path = __path.replace("{social_account_uid}", &encode_path(social_account_uid));
...
pub async fn insights(client: &Client, social_account_uid: &str, query: &AccountInsightsQuery) -> ApiResult<Vec<Insight>> {
...
///
/// Requires `ViewInsights` in the account's group.
pub async fn insights_history(client: &Client, social_account_uid: &str, query: &InsightHistoryQuery) -> ApiResult<Vec<InsightSeries>> {
...
pub async fn list(client: &Client, query: &ListSocialAccountsQuery) -> ApiResult<Vec<SocialAccountResponse>> {
...
pub async fn native_disconnect(client: &Client, social_account_uid: &str) -> ApiResult<()> {
...
///
/// Requires `ConnectSocialAccounts` in the account's group.
pub async fn native_logout(client: &Client, social_account_uid: &str) -> ApiResult<()> {
...
pub async fn native_pairing_status(client: &Client, pairing_handle: &str) -> ApiResult<NativePairingStatusResponse> {
  let mut __path = String::from("/social-account-pairing/{pairing_handle}/status");
  __path = __path.replace("{pairing_handle}", &encode_path(pairing_handle));
  client.request(Method::GET, &__path, None::<&()>, None::<&()>).await
}
/// The current pairing QR to render (null until the first code arrives).
///
/// Requires `ConnectSocialAccounts` in the group the pairing targets.
pub async fn native_qr(client: &Client, pairing_handle: &str) -> ApiResult<NativeQrResponse> {
...
///
/// Requires `ConnectSocialAccounts` in the account's group.
pub async fn native_reconnect(client: &Client, social_account_uid: &str) -> ApiResult<()> {
...
///
/// Requires `ViewSocialAccounts` in the account's group.
pub async fn native_status(client: &Client, social_account_uid: &str) -> ApiResult<SessionStatus> {
...
pub async fn refresh_profile(client: &Client, social_account_uid: &str) -> ApiResult<RefreshProfileResponse> {
...
///
/// Requires `UpdateSocialAccounts` in the account's group.
pub async fn set_alias(client: &Client, social_account_uid: &str, body: &SetSocialAccountAliasRequest) -> ApiResult<()> {
...
///
/// Requires `UpdateSocialAccounts` in the account's group.
pub async fn set_enabled(client: &Client, social_account_uid: &str, body: &SetSocialAccountEnabledRequest) -> ApiResult<()> {
...
///
/// Requires `ConnectSocialAccounts` in the named group.
pub async fn start_native_pairing(client: &Client, body: &ConnectNativeRequest) -> ApiResult<StartNativePairingResponse> {
...
///
/// Requires `ConnectSocialAccounts` in the account's group.
pub async fn stevo_disconnect(client: &Client, social_account_uid: &str) -> ApiResult<()> {
...
///
/// Requires `ConnectSocialAccounts` in the account's group.
pub async fn stevo_logout(client: &Client, social_account_uid: &str) -> ApiResult<()> {
...
///
/// Requires `ConnectSocialAccounts` in the account's group.
pub async fn stevo_pair(client: &Client, social_account_uid: &str, body: &StevoPairRequest) -> ApiResult<StevoPairResponse> {
...
///
/// Requires `ConnectSocialAccounts` in the account's group.
pub async fn stevo_qr(client: &Client, social_account_uid: &str) -> ApiResult<StevoQrResponse> {
...
///
/// Requires `ConnectSocialAccounts` in the account's group.
pub async fn stevo_reconnect(client: &Client, social_account_uid: &str) -> ApiResult<()> {
...
///
/// Requires `ViewSocialAccounts` in the account's group.
pub async fn stevo_status(client: &Client, social_account_uid: &str) -> ApiResult<StevoStatusResponse> {
